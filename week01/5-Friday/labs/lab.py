...
def letterReplace(first, last):
    
    print(f"""
    {first} {last}
    1234 Park St
    A  nytown, Pennsylvania 12345
    ...
    My name is {first} {last}. I have served as a science teacher at Parktown High School for the past fifteen years and have had the privilege to serve as 
    {first}’s teacher for the past three. I have also been {first}’s advisor on the science academic team here at school. Due to his qualifications, I feel that Ryan would be an excellent addition to your school.
    ...
    Ryan would bring much to your school, both in and out of the classroom. If you have any questions regarding Ryan’s qualifications, please contact me at (123) 555-5555 or at {first}.Jones@email.com.
